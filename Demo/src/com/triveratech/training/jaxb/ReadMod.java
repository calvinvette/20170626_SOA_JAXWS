...
public class ReadMod {
    ...
    public static void main( String[] args ) {
        try {
            ...
            Personnel ps = (Personnel)pse;

            PERSONType newPerson = new PERSONType();
            newPerson.setGIVENNAME("Frank");
            newPerson.setSURNAME("NStein");
            ps.getPERSON().add(newPerson);
